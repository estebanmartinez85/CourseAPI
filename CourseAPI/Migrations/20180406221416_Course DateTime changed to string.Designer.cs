...
namespace CourseAPI.Migrations
{
    ...
    [Migration("20180406221416_Course DateTime changed to string")]
    partial class CourseDateTimechangedtostring
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseAPI.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("CourseAPI.Models.Course", b =>
                {
                    ...
                    b.Property<bool>("StoryboardComplete");
                    ...
                    b.Property<bool>("WriterMeetingCompleted");

                    b.Property<string>("WriterMeetingDate");
            ...
            modelBuilder.Entity("CourseAPI.Models.CourseUsers", b =>
                {
            ...
            modelBuilder.Entity("CourseAPI.Models.Library", b =>
                {
                    b.Property<int>("LibraryId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CourseAPI.Models.CourseUsers", b =>
                {
                    ...
                    b.HasOne("CourseAPI.Models.ApplicationUser", "User")
                        .WithMany("CourseUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CourseAPI.Models.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CourseAPI.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
